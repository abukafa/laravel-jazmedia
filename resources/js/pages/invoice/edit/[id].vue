<script setup>
import InvoiceAddPaymentDrawer from '@/views/invoice/InvoiceAddPaymentDrawer.vue'
import InvoiceEditable from '@/views/invoice/InvoiceEditable.vue'
import InvoiceSendInvoiceDrawer from '@/views/invoice/InvoiceSendInvoiceDrawer.vue'

const invoiceData = ref()
const route = useRoute('invoice-edit-id')
