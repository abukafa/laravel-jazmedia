<script setup>
import AcademyAssignmentProgress from '@/views/academy/AcademyAssignmentProgress.vue'
import AcademyCardPopularInstructors from '@/views/academy/AcademyCardPopularInstructors.vue'
import AcademyCardTopCourses from '@/views/academy/AcademyCardTopCourses.vue'
import AcademyCourseTable from '@/views/academy/AcademyCourseTable.vue'
import AcademyTopicYouAreInterested from '@/views/academy/AcademyTopicYouAreInterested.vue'
import AcademyUpcomingWebinar from '@/views/academy/AcademyUpcomingWebinar.vue'
