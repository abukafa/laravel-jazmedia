...
import UserConnections from '@/views/user-profile/connections/index.vue'
import UserProfile from '@/views/user-profile/profile/index.vue'
import UserProjects from '@/views/user-profile/projects/index.vue'
import UserTeam from '@/views/user-profile/team/index.vue'
